...
- [x] 2026-07-01 Scope Phase A of the Aion agent architecture — voice setup + first real draft path. Both stated blockers (Brain tab paused, aion_config missing) were already resolved; research confirmed end-to-end path is live. — see PR
