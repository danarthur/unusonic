  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 relative z-50 max-h-(--radix-select-content-available-height) min-w-[8rem] origin-(--radix-select-content-transform-origin) overflow-x-hidden overflow-y-auto rounded-[var(--stage-radius-panel)] border border-[oklch(1_0_0_/_0.08)] bg-[var(--stage-surface-raised)] text-[var(--stage-text-primary)] shadow-[0_8px_32px_-4px_oklch(0_0_0/0.6)]",
          position === "popper" &&
...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.Label
      ...
      className={cn("text-[var(--stage-text-secondary)] px-2 py-1.5 text-xs", className)}
      {...props}
    />
  )
}
...
function SelectSeparator({
  ...
  return (
    <SelectPrimitive.Separator
      ...
      className={cn("bg-[oklch(1_0_0_/_0.06)] pointer-events-none -mx-1 my-1 h-px", className)}
      {...props}
    />
  )
}
