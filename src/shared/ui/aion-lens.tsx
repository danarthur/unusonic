...
type AionLensProps = {
  /** Stub predictive insight (e.g. "Aion predicts this invoice will be 4 days late"). */
  insight?: string;
...
/**
 * Aion Lens — icon that shows a predictive insight for this widget (stub).
 * Place next to widget headers; tapping opens a popover with the insight.
 */
export function AionLens({ insight = 'Aion insight will appear here once connected.', className }: AionLensProps) {
