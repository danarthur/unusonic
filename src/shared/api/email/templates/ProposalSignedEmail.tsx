...
export function ProposalSignedEmail({
  ...
  return (
    <Html>
      <Head />
      <Preview>{signerName} signed — {dealTitle}</Preview>
      <Body style={main}>
        <Container style={container}>
          <Section style={section}>
            <Text style={heading}>Proposal signed</Text>
            <Text style={body}>
              {signerName} has signed the proposal for {dealTitle} on {formattedDate}.
            </Text>
            <Button href={crmUrl} style={button}>
              View in CRM
            </Button>
            <Text style={footer}>
              This is an internal notification. Reply to this email if you have questions.
            </Text>
          </Section>
        </Container>
      </Body>
