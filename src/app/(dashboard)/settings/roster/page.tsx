      ...
      <div className="p-6 max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-[var(--glass-bg)] border border-[var(--glass-border)] flex items-center justify-center shrink-0">
            <Users className="w-5 h-5 text-ink-muted" aria-hidden />
          </div>
          <div className="min-w-0">
            <h1 className="text-2xl font-medium tracking-tight text-ceramic">Roster</h1>
        ...
        <div className="liquid-panel border border-[var(--glass-border)] rounded-2xl p-6 space-y-4">
          <div>
            <h2 className="text-base font-medium tracking-tight text-ceramic">Job titles</h2>
        ...
        <div className="liquid-panel border border-[var(--glass-border)] rounded-2xl p-6 space-y-4">
          <div>
            <h2 className="text-base font-medium tracking-tight text-ceramic">Skill presets</h2>
            <p className="text-xs text-ink-muted mt-0.5">
