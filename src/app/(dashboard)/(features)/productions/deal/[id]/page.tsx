 ...
 *
 * The real deal experience lives at /productions?selected=<dealId> (Prism Deal lens).
 * This file used to render a stub read-only view with no tabs, Prism, Production
 * Team Card, or handoff button — a trap for any caller that treated /productions/deal/[id]
...
export default async function DealDetailPage({
  ...
  redirect(`/productions?selected=${dealId}`);
}
