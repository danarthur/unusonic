 ...
 *
 * The real deal experience lives at /crm?selected=<dealId> (Prism Deal lens).
 * This file used to render a stub read-only view with no tabs, Prism, Production
 * Team Card, or handoff button — a trap for any caller that treated /crm/deal/[id]
