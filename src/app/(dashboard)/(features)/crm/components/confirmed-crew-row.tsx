...
import { X, Loader2, CheckCheck, Clock, StickyNote, ChevronDown, DollarSign, Wrench } from 'lucide-react';
...
export function ConfirmedCrewRow({
  ...
  return (
    <div className="rounded-xl border border-[oklch(1_0_0/0.12)] bg-[var(--ctx-card)] p-3 flex flex-col gap-1">
      <CrewIdentityRow
        row={row}
      ...
      {/* Pay section — always visible for confirmed crew */}
      {row.confirmed_at && !rateReadOnly && (
        <div className="border-t border-[oklch(1_0_0/0.04)] mt-1 pt-1">
