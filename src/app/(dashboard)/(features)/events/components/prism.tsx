...
export function Prism({
  ...
  // revert + toast. server-side revalidatePath('/events') in updateDealStatus
  ...
  return (
    ...
    >
      ...
      <div ref={scrollContainerRef} className="flex-1 min-h-0 overflow-y-auto p-6" style={{ background: 'var(--stage-void)' }} data-surface="void">
         ...
         * forever — and once held, clicking Deal/Ledger flipped the active
         * lens state but never unmounted the Plan content underneath. Fix
         * was previously landed on /crm but lost in the /crm → /productions
         * → /events rename; reapplied here.
         *
                      ...
                      {linkedDealLoading ? (
                        ...
                        <>
                          ...
                          <div className="mt-5 pt-5 border-t border-[oklch(1_0_0_/_0.10)] flex flex-wrap items-center gap-3">
                            ...
                            <a
                              href={`/events?stream=active&selected=${linkedDeal.id}`}
