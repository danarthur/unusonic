        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {emails.map((email) => (
            ...
            >
              ...
              {/* Content */}
              <h2 className="text-lg font-bold mb-3 text-[var(--stage-text-primary)] leading-tight group-hover:text-[var(--stage-text-primary)] transition-colors">
                {email.subject}
              </h2>
              ...
              <div className="mt-auto stage-panel !rounded-2xl !p-3">
                 <h3 className="text-[10px] text-[var(--stage-text-secondary)] mb-2 uppercase tracking-widest font-bold flex items-center gap-2">
