...
import {
  selectInboundBodyText,
  type PostmarkInboundPayload,
} from './__lib__/body-selection';
...
// Payload types + body selection live in __lib__/body-selection.ts so the
// Next.js auto-generated route-type checker doesn't choke on non-handler
// exports next to the POST handler. Imported above.
