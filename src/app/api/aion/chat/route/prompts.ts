...
export function buildSystemPrompt(
  ...
  parts.push(
    ...
    '- Default to 2-3 sentences. For overview or recap queries (e.g. "what\'s urgent", "catch me up", "what needs my attention"), 4-6 short sentences is fine — but stay under ~80 words.',
    '- When offering choices at the end of a response, write a complete sentence with subject and verb: "Want me to start with the oldest one, or would you prefer the full queue first?" Never start a closing clause with a bare lowercase noun phrase ("the oldest one, or...").',
